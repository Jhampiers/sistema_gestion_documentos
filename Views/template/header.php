...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo"  style="background-color:#40AABD;">
            ...
            <div class="app-menu" style="background-color:#46B4B4;">
                <ul class="accordion-menu">
                    <li class="sidebar-title text-white fw-bold" >
                        Menús
                    </li>
                    <?php if ($_SESSION['rol'] == 1) { ?>
                        <li class="<?php echo ($data['menu'] == 'usuarios') ? 'active-page' : ''; ?>">
                            <a href="<?php echo BASE_URL . 'usuarios'; ?>" class="<?php echo ($data['menu'] == 'usuarios') ? 'active' : ''; ?>text-white fw-bold fs-6">
                    ...
                    <li class="<?php echo ($data['menu'] == 'share') ? 'active-page' : ''; ?>">
                        <a href="<?php echo BASE_URL . 'compartidos'; ?>" class="<?php echo ($data['menu'] == 'share') ? 'active' : ''; ?>text-white fw-bold fs-6"><i class="material-icons-two-tone">inbox</i>Compartidos<span class="badge rounded-pill badge-danger float-end"><?php echo $data['shares']['total']; ?></span></a>
                    </li>
                    <li class="<?php echo ($data['menu'] == 'admin') ? 'active-page' : ''; ?>">
                        <a href="<?php echo BASE_URL . 'admin'; ?>" class="<?php echo ($data['menu'] == 'admin') ? 'active' : ''; ?>text-white fw-bold fs-6"><i class="material-icons-two-tone">cloud_queue</i>Gestionar Archivos</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown"><img src="<?php echo BASE_URL . 'Assets/images/logo1.png'; ?>" alt=""></a>
