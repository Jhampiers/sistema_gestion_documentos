                ...
                if ($id_usuario == '') {
                    ...
                    if (empty($verificarUsuario)) {
                        ...
                        if (empty($verificarCorreo)) {
                            ...
                            if (empty($verificarTel)) {
                                ...
                                $data = $this->model->registrar($usuario, $nombre, $apellido, $correo, $telefono, $direccion, $hash, $rol);
                                if ($data > 0) {
                    ...
                    if (empty($verificarUsuario)) {
                        ...
                        if (empty($verificarCorreo)) {
                            ...
                            if (empty($verificarTel)) {
                                $hash = password_hash($clave, PASSWORD_DEFAULT);
                                $data = $this->model->modificar($usuario, $nombre, $apellido, $correo, $telefono, $direccion, $rol, $id_usuario);
                                if ($data == 1) {
