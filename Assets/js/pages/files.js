...
document.addEventListener('DOMContentLoaded', function () {
    ...
    eliminar.forEach(enlace => {
        enlace.addEventListener('click', function (e) {
            ...
            eliminarRegistro('ESTA SEGURO DE ELIMINAR', 'ARCHIVO COMPARTIDO', 'SI ELIMINAR', url, null)
        })
    });
    ...
    if (document.querySelector('#btnEliminar')) {
        document.querySelector('#btnEliminar').addEventListener('click', function(e){
            const url = base_url + 'carpetas/eliminar/' + id_carpeta.value;
            eliminarRegistro('ESTA SEGURO DE ELIMINAR', 'LA CARPETA Y SUS ARCHIVOS SE ELIMINARÁ DE FORMA PERMANENTE', 'SI ELIMINAR', url, null)
        })
    }
})
